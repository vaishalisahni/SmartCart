...
const seed = async () => {
  ...
  // Admin user
  // Let Mongoose pre-save hook handle hashing — don't hash manually
  await User.create({ name: 'Admin', email: 'admin@smartcart.com', password: 'admin123', role: 'admin', isVerified: true });
  await User.create({ name: 'Test User', email: 'user@smartcart.com', password: 'user123', isVerified: true });

  // Products
  const { v4: uuidv4 } = require('uuid');
  await Product.insertMany([
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Wireless Bluetooth Headphones', description: 'Premium sound quality with 30hr battery, noise cancellation, foldable design.', price: 2499, originalPrice: 4999, discountPercent: 50, images: ['https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600'], category: elec._id, brand: 'SoundMax', stock: 50, tags: ['audio', 'wireless', 'bluetooth'], isFeatured: true, isBestSeller: true, ratings: 4.5, numReviews: 120 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Smart LED TV 43"', description: '4K Ultra HD Smart TV with built-in Android, WiFi, and multiple HDMI ports.', price: 27999, originalPrice: 35000, discountPercent: 20, images: ['https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=600'], category: elec._id, brand: 'VisionTech', stock: 20, tags: ['tv', 'smart', '4k'], isFeatured: true, ratings: 4.3, numReviews: 85 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Mechanical Keyboard', description: 'RGB backlit, TKL layout, blue switches, USB-C, built for gamers and coders.', price: 3499, originalPrice: 5000, discountPercent: 30, images: ['https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=600'], category: elec._id, brand: 'TechKey', stock: 35, tags: ['keyboard', 'gaming', 'rgb'], ratings: 4.7, numReviews: 200 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: "Men's Casual T-Shirt", description: '100% cotton, breathable fabric, available in multiple sizes and colours.', price: 399, originalPrice: 799, discountPercent: 50, images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600'], category: cloth._id, brand: 'StyleWear', stock: 200, tags: ['tshirt', 'casual', 'cotton'], isBestSeller: true, ratings: 4.2, numReviews: 350 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Running Shoes', description: 'Lightweight, cushioned running shoes for all terrain. EVA sole for comfort.', price: 1999, originalPrice: 3500, discountPercent: 43, images: ['https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600'], category: sports._id, brand: 'RunFast', stock: 80, tags: ['shoes', 'running', 'sports'], isFeatured: true, ratings: 4.6, numReviews: 180 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Python Programming Book', description: 'Complete Python guide from basics to advanced — includes ML, web dev chapters.', price: 599, originalPrice: 899, discountPercent: 33, images: ['https://images.unsplash.com/photo-1532012197267-da84d127e765?w=600'], category: books._id, brand: 'TechPublish', stock: 100, tags: ['python', 'programming', 'education'], ratings: 4.8, numReviews: 420 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Air Fryer 4L', description: 'Digital display, 8 presets, non-stick basket, 1400W, healthy oil-free cooking.', price: 4499, originalPrice: 7000, discountPercent: 36, images: ['https://images.unsplash.com/photo-1585515320310-259814833e62?w=600'], category: home._id, brand: 'HomeCook', stock: 40, tags: ['kitchen', 'airfryer', 'cooking'], isFeatured: true, isBestSeller: true, ratings: 4.4, numReviews: 95 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Yoga Mat Premium', description: 'Non-slip 6mm thick mat, eco-friendly TPE material, carrying strap included.', price: 799, originalPrice: 1500, discountPercent: 47, images: ['https://images.unsplash.com/photo-1518611012118-696072aa579a?w=600'], category: sports._id, brand: 'FitLife', stock: 120, tags: ['yoga', 'fitness', 'mat'], ratings: 4.5, numReviews: 230 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: 'Smartphone Stand', description: 'Adjustable aluminum desk stand for phones and tablets, 360° rotation.', price: 349, originalPrice: 599, discountPercent: 42, images: ['https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=600'], category: elec._id, brand: 'DeskPro', stock: 150, tags: ['stand', 'phone', 'desk'], ratings: 4.1, numReviews: 75 },
    { sku: uuidv4().slice(0, 8).toUpperCase(), name: "Women's Kurti", description: 'Rayon fabric, floral print, A-line fit. Perfect for casual and festive occasions.', price: 699, originalPrice: 1299, discountPercent: 46, images: ['https://images.unsplash.com/photo-1614676471928-2ed0ad1061a4?w=600'], category: cloth._id, brand: 'EthnicWear', stock: 160, tags: ['kurti', 'ethnic', 'women'], isBestSeller: true, ratings: 4.3, numReviews: 280 },
  ]);
